...
wheel_data has 344 observations and 14 variables while the final precipication dataframe had 24 observations of 3 variables. This makes sense for the precipitation data frame since the data is the monthly precipitation for 2 years.The dataset includes many interesting information such as the median number of sports balls in 2017 was `r median(pull(filter(wheel_data,year==2019),sports_balls))`and the total precipitation for 2018 was `r  sum(pull(filter(precip_total,year==2018),inches))`.
